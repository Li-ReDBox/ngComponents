describe('component: datePickerUib', function() {
  ...
  it('should be closed by default', function() {
    var ctrl = $componentController('datePickerUib', null, {picker: {}});
  ...
  it('should accept extra keys for picker', function() {
    ...
    var bindings = {picker: {date: setDate, title: 'test'}};
    var ctrl = $componentController('datePickerUib', null, bindings);
  ...
  it('should have default option with only maxDate as today', function() {
    ...
    expect(ctrl.options.maxDate).toEqual(new Date());
  });

  it('should have allow minDate to be set in options', function() {
    var bindings = {picker: {minDate: new Date(2016, 0, 1), title: 'test'}};
    var ctrl = $componentController('datePickerUib', null, bindings);
