describe('component: datePickers', function() {
  ...
  it('should call the `collect` binding with an array of dates', function() {
    ...
    var date1 = new Date(2016,6,1), date2 = new Date(2016, 7, 14);
    var pickers = [{title: 'start', class: 'col-md-3', date: date1},
                   {title: 'end', class: 'col-md-3', date: date2}];
